...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--out-dir", required=True, help="directorio ra??z de resultados")
    ...
    parser.add_argument("--run-analysis", action="store_true", help="correr an??lisis VLM despu??s de extraer")
    ...
    parser.add_argument("--max-tokens", type=int, default=800, help="m??ximo de tokens de salida por item")
