...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--out-dir", required=True, help="directorio raÇðz de resultados")
    ...
    parser.add_argument("--run-analysis", action="store_true", help="correr anÇ­lisis VLM despuÇ¸s de extraer")
    parser.add_argument("--server", default=None, help="endpoint OpenAI-compatible del VLM")
    parser.add_argument("--context-mode", choices=["none", "bm25", "full"], default="bm25",
                        help="none = solo imagen+caption | bm25 = contexto recuperado | full = texto completo")
    parser.add_argument("--max-context-words", type=int, default=0, help="solo para context-mode=full")
    parser.add_argument("--top-k", type=int, default=6, help="solo para context-mode=bm25")
    parser.add_argument("--chunk-words", type=int, default=180, help="solo para context-mode=bm25")
    parser.add_argument("--chunk-overlap", type=int, default=30, help="solo para context-mode=bm25")
    parser.add_argument("--max-tokens", type=int, default=800, help="mÇ­ximo de tokens de salida por item")
